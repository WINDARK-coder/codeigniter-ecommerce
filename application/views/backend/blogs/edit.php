    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-primary">
                ...
                <form action="<?= base_url('blogs/edit/' . $item->id); ?>" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="post_by" class="form-control" value="<?= $item->post_by; ?>" placeholder="Enter post_by">
