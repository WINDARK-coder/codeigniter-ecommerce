                    ...
                    <div class="row">
                        <div class="col-sm-6 new-customer">
                            ...
                            <div class="bottom-form">
                                <a href="<?= base_url('frontend/Register/index'); ?>" class="btn btn-default pull-right">Continue</a>
                            </div>
                        </div>

                        <form action="<?= base_url('frontend/Login/index'); ?>" method="post" enctype="multipart/form-data">
