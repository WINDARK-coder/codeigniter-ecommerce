        ...
        <div id="content" class="col-sm-12">
            ...
            <div class="table-responsive form-group">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td class="text-center"><a href="<?= base_url('frontend/Product/index/') . $cart_products->id; ?>"><img width="70px" src="<?= base_url() . $cart_products->path; ?>" alt="<?= $cart_products->title ?>" title="<?= $cart_products->title ?>" class="img-thumbnail" /></a></td>
                            <td class="text-left"><a href="<?= base_url('frontend/Product/index'); ?>"><?= $cart_products->title ?></a><br />
                            ...
                            <td class="text-right">$<?= $cart_products->sales_price ?></td>
                            <td class="text-right">$<?= $cart_products->sales_price . '*' . $cart_products->quantity ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="buttons">
                <div class="pull-left"><a href="<?= base_url('frontend/Home/index'); ?>" class="btn btn-default">Continue Shopping</a></div>
                <div class="pull-right"><a href="<?= base_url('frontend/Checkout/index'); ?>" class="btn btn-primary">Checkout</a></div>
            </div>
        </div>
        <!--Middle Part End -->
