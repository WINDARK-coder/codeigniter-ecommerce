                    ...
                    <tbody>
                        <tr>
                            <td class="text-center">
                                <a href="<?= base_url('frontend/Product/index'); ?>"><img width="70px" src="<?= base_url(); ?>assets/frontend/image/demo/shop/product/18.jpg" alt="Aspire Ultrabook Laptop" title="Aspire Ultrabook Laptop">
                                </a>
                            </td>
                            <td class="text-left"><a href="<?= base_url('frontend/Product/index'); ?>">iPod Classic</a>
                            </td>
                        ...
                        <tr>
                            <td class="text-center">
                                <a href="<?= base_url('frontend/Product/index'); ?>"><img width="70px" src="<?= base_url(); ?>assets/frontend/image/demo/shop/product/e1.jpg" alt="Xitefun Causal Wear Fancy Shoes" title="Xitefun Causal Wear Fancy Shoes"></a>
                            </td>
                            <td class="text-left"><a href="<?= base_url('frontend/Product/index'); ?>">Samsung Galaxy Tab 10.1</a>
                            </td>
